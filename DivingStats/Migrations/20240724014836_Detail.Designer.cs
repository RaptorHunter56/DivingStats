...
namespace DivingStats.Migrations
{
    ...
    [Migration("20240724014836_Detail")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DivingStats.Data.Score", b =>
                {
                    ...
                    b.Property<int>("JudgeNo")
                        .HasColumnType("INTEGER");

                    b.Property<decimal>("Value")
                        .HasColumnType("TEXT");

                    b.HasKey("JudgeID", "DiverID", "RoundID", "RoundNumber");

                    b.HasIndex("DiverID", "RoundID", "RoundNumber");
            ...
            modelBuilder.Entity("DivingStats.Data.Score", b =>
                {
                    b.HasOne("DivingStats.Data.Judge", "Judge")
                        .WithMany("Scores")
                        .HasForeignKey("JudgeID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DivingStats.Models.IndividualDive", "IndividualDive")
                        .WithMany("Scores")
                        .HasForeignKey("DiverID", "RoundID", "RoundNumber")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("IndividualDive");
